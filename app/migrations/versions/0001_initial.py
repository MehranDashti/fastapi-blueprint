"""create users and examples

Revision ID: 0001
Revises:
Create Date: 2026-05-30

Initial schema for the blueprint: independent `users` and `examples` tables.
Generated to match app/models — regenerate with `alembic revision --autogenerate`
once you change the models.
"""
